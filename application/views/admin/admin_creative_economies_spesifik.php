...
<head>
 ...
 <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Daftar Anggota Ekonomi Kreatif</h4>
                  <hr>
...
?>
                  ...
                  <a href="<?php echo base_url().'admin/tambah_creative_economies'?>"> <button type="button" id="btn-tambah" class="btn btn-success btn-rounded btn-fw" style="margin: 1%;float: right;">
    ...
    foreach($data as $data){
      if ($data['creative_economy_category_id']==$kategori){
    ?>
      <tr>
        ...
        <!-- <td class="align-middle"><?php echo $data->updated_at; ?></td>
         --><td class="align-middle text-center">
          ...
          <a href="<?php echo base_url().'admin/delete_creative_economies/'.$data['id']?>" onclick="return confirm('Are you sure delete?')" class="btn btn-danger btn-alert-hapus"><span class="ti-trash"></span>hapus</a>
        </td>
      </tr>
  ...
  <div class="modal-dialog modal-dialog-lg">
    ...
    " >
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" disabled value="<?php echo $data['contact_person']; ?>">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm">
                    <div class="form-group">
                      <label for="exampleInputConfirmPassword1">Nomor Pemilik</label>
                      <input type="text" class="form-control" disabled value="<?php echo $data['contact_number']; ?>">
                    </div>
                    <div class="form-group">
