 ...
 <div class="col-lg-12 grid-margin stretch-card">
    ...
    ?>
      <tr>
        ...
        <td class="align-middle"><a href="<?php echo '#detil'.$no;?>"><img src="<?php echo $base_url.'upload/destination-categories/'.$data['icon']; ?>" height="200"></a></td>
      ...
      <div class="card">
                <div class="card-body">
                     <div class="form-group" style="text-align: center;">
                      <img src="<?php echo $base_url.'upload/destination-categories/'.$data['icon']; ?>" style="max-width: 100%;
    height: auto;
    width: auto\9; 
    float: center;
    text-align: center;
