...
?>
    ...
    ?>
      <tr>
        ...
        <td class="align-middle"><a href="<?php echo '#detil'.$no;?>"><img src="<?=base_url().'images/destinations/'.$data['photo']; ?>" ></a></td>
      ...
      <div class="card">
                <div class="card-body">
                     <div class="form-group" style="text-align: center;">
                      <img  src="<?=base_url().'images/destinations/'.$data['photo']; ?>" style="max-width: 100%;
    height: auto;
    width: auto\9; 
    float: center;
    text-align: center;
