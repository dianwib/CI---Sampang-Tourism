...
<body>
  <div class="container-scroller"><nav class="navbar bg-custom-2 col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="<?php echo base_url().'admin/dashboard'?>"><img src="<?php echo base_url().'assets_admin/images/logo.png'?>" class="mr-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="<?php echo base_url().'admin/dashboard'?>"><img src="<?php echo base_url().'assets_admin/images/logo-mini.png'?>" alt="logo"/></a>
      </div>
