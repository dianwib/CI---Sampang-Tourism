 ...
 <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <a href="<?php echo base_url().'admin/tambah_news'?>"> <button type="button" id="btn-tambah" class="btn btn-success btn-rounded btn-fw" style="margin: 1%;float: right;">
    ...
    ?>
      <tr>
        ...
        <td class="align-middle"><a href="<?php echo '#detil'.$no;?>"><img src="<?php echo $base_url.'upload/news/'.$data['picture']; ?>" ></a></td>
        ...
        <!-- <td class="align-middle"><?php echo $data->updated_at; ?></td>
         --><td class="align-middle text-center">
          ...
          <a href="<?php echo base_url().'admin/edit_news/'.$data['id']?>" data-id="<?php echo $data['id']; ?>"  class="btn btn-warning btn-form-ubah" style="color: white;"><span class="ti-pencil"></span>ubah</a>

        
          <a href="<?php echo base_url().'admin/delete_news/'.$data['id']?>" onclick="return confirm('Are you sure delete?')" class="btn btn-danger btn-alert-hapus"><span class="ti-trash"></span>hapus</a>
        </td>
      </tr>
  ...
  <div class="modal-dialog modal-dialog-lg">
      ...
      <div class="card">
                <div class="card-body">
                     <div class="form-group" style="text-align: center;">
                      <img  src="<?php echo $base_url.'upload/news/'.$data['picture']; ?>" style="max-width: 100%;
    height: auto;
    width: auto\9; 
    float: center;
    text-align: center;
    " >
                    ...
                    <div class="form-group">
                      <label for="exampleInputUsername1">Deskripsi Berita</label>
