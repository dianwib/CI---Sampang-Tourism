...
<body>
    ...
    <div class="well">
        <a href="<?php echo base_url().'admin/tambah_destination_categories'?>"> <button type="button" id="btn-tambah" class="btn btn-success pull-right">
  ...
  <table class="table table-bordered">
    ...
    ?>
      <tr>
        ...
        <td class="align-middle"><img src="<?=base_url().'images/destination_categories/'.$data['icon']; ?>" height="200"></td>
        ...
        <!-- <td class="align-middle"><?php echo $data->updated_at; ?></td>
         --><td class="align-middle text-center">
          <a href="<?php echo base_url().'admin/edit_destination_categories/'.$data['id']?>" data-id="<?php echo $data['id']; ?>"  class="btn btn-default btn-form-ubah"><span class="glyphicon glyphicon-pencil"></span>ubah</a>

        </td>
        <td class="align-middle text-center">
          <a href="<?php echo base_url().'admin/delete_destination_categories/'.$data['id']?>" onclick="return confirm('Are you sure delete?')" class="btn btn-danger btn-alert-hapus"><span class="glyphicon glyphicon-erase"></span>hapus</a>
        </td>
      </tr>
    <?php
