<div class="wrapper">
  <nav>
    ...
    <ul>
      ...
      <li><a href="<?php echo base_url().'admin/profile'?>" class="active">Profile</a></li>
...
<body>
    ...
    <div class="well">
        <a href="<?php echo base_url().'admin/tambah_profile'?>"> <button type="button" id="btn-tambah" class="btn btn-success pull-right">
      ...
      <tr>
        ...
        <!-- <td class="align-middle"><?php echo $data->updated_at; ?></td>
         --><td class="align-middle text-center">
          <a href="<?php echo base_url().'admin/edit_profile/'.$data['id']?>" data-id="<?php echo $data['id']; ?>"  class="btn btn-default btn-form-ubah"><span class="glyphicon glyphicon-pencil"></span>ubah</a>

        </td>
        <td class="align-middle text-center">
          <a href="<?php echo base_url().'admin/delete_profile/'.$data['id']?>" onclick="return confirm('Are you sure delete?')" class="btn btn-danger btn-alert-hapus"><span class="glyphicon glyphicon-erase"></span>hapus</a>
        </td>
      </tr>
    <?php
