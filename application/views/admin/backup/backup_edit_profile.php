...
<body>
    ...
    <div class="table-responsive">
      <form class="form-signin" action="<?php echo base_url().'Admin/put_profile/'.$data->id ?>" method="post"  enctype="multipart/form-data">
            <table>
      ...
      <tr>
              ...
              <td><input type="text" name="title" required class="title-value" value="<?php echo $data->title; ?>">
                <td><input type="text" name="order" required class="title-value" value="<?php echo $data->order; ?>">
                      ...
                      </td><td><textarea name="content" required rows="15" cols="75" class="content-value" ><?php echo $data->content; ?></textarea></td>
