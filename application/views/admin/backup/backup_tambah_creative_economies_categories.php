...
<body>
    ...
    <div class="table-responsive">
      <form class="form-signin" action="<?php echo base_url().'Admin/post_creative_economies_categories' ?>" method="post" enctype="multipart/form-data">
            <table>
  ...
  <table class="table table-bordered">
    <tr>
      ...
      <tr>
              ...
              <td><input type="text" class="title-value" name="title" required>
              
              </td><td><input required class="picture-value" type="file" id="icon" name="picture" required="" accept="image/*">
             </td><td><input type="number" class="title-value" name="order" required>
              

        </td>
      </tr>

   </table>  <input style="background-color: #e44c65 " type="submit" class="btn btn-primary" value=" &nbsp Tambah &nbsp"></form>
      </div></div></body>
</html>
