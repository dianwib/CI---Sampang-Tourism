<div class="wrapper">
  <nav>
    ...
    <ul>
      ...
      <li><a href="<?php echo base_url().'admin/creative_economies_categories'?>" >Creative-economies-categories</a></li><li><a href="<?php echo base_url().'admin/profile'?>" class="active">Profile</a></li>
...
<body>
    <div class="well">
        <h2 style="margin-top: 0;">Data profile</h2>
    </div>
  ...
  <table class="table table-bordered">
    <tr>
      ...
      <tr>
              ...
              </td><td><textarea required class="content-value" name="content" rows="15" cols="75"></textarea>
