...
<body>
    <div class="well">
        <a href="<?php echo base_url().'admin/tambah_destinations'?>"> <button type="button" id="btn-tambah" class="btn btn-success pull-right">
...
?>
  ...
  <table class="table table-bordered">
    ...
    foreach($data as $data){
      if ($data['destination_category_id']==$kategori){
    ...
    ?>
      <tr>
        ...
        <td class="align-middle"><img src="<?=base_url().'images/destinations/'.$data['photo']; ?>" height="200"></td>
        <td class="align-middle"><?php echo $data['opening_hours']; ?></td>
        <td class="align-middle"><?php echo $data['closing_hours']; ?></td>
        ...
        <!-- <td class="align-middle"><?php echo $data->updated_at; ?></td>
         --><td class="align-middle text-center">
          <a href="<?php echo base_url().'admin/edit_destinations/'.$data['id']?>" data-id="<?php echo $data['id']; ?>"  class="btn btn-default btn-form-ubah"><span class="glyphicon glyphicon-pencil"></span>ubah</a>

        </td>
        <td class="align-middle text-center">
          <a href="<?php echo base_url().'admin/delete_destinations/'.$data['id']?>" onclick="return confirm('Are you sure delete?')" class="btn btn-danger btn-alert-hapus"><span class="glyphicon glyphicon-erase"></span>hapus</a>
        </td>
      </tr>
    <?php
