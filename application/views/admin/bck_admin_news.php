...
<body>
    <div class="well">
        <a href="<?php echo base_url().'admin/tambah_news'?>"> <button type="button" id="btn-tambah" class="btn btn-success pull-right">
            <span class="glyphicon glyphicon-plus"></span>  Tambah Data</button></a>
        
        <h2 style="margin-top: 0;">Data News</h2>
    </div>
  ...
  <table class="table table-bordered">
    ...
    ?>
      <tr>
        ...
        <td class="align-middle"><img src="<?=base_url().'images/news/'.$data['picture']; ?>" height="200"></td>
        <td class="align-middle"><?php echo $data['created_at']; ?></td>
        <!-- <td class="align-middle"><?php echo $data->updated_at; ?></td>
         --><td class="align-middle text-center">
          <a href="<?php echo base_url().'admin/edit_news/'.$data['id']?>" data-id="<?php echo $data['id']; ?>"  class="btn btn-default btn-form-ubah"><span class="glyphicon glyphicon-pencil"></span>ubah</a>

        </td>
        <td class="align-middle text-center">
          <a href="<?php echo base_url().'admin/delete_news/'.$data['id']?>" onclick="return confirm('Are you sure delete?')" class="btn btn-danger btn-alert-hapus"><span class="glyphicon glyphicon-erase"></span>hapus</a>
        </td>
      </tr>
    <?php
