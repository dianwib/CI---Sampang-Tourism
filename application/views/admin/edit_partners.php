...
<body>
    ...
    <div class="table-responsive">
      <form class="form-signin" action="<?php echo base_url().'Admin/put_partners/'.$data->id ?>" method="post"  enctype="multipart/form-data">
            <table>
  ...
  <table class="table table-bordered">
    <tr>
      ...
      <tr>
              ...
              <td><input type="text" name="name" required class="title-value" value="<?php echo $data->name; ?>">

              <td><input type="text" name="url" required class="title-value" value="<?php echo $data->url; ?>">
              </td><td><img src="<?=base_url().'images/partners/'.$data->picture; ?>" height="200">
