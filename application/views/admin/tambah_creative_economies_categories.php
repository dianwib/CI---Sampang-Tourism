...
<head>
 ...
 <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Tambah Kategori Ekonomi Kreatif</h4>
                  <hr>
                ...
                <form class="form-signin" action="<?php echo base_url().'Admin/post_creative_economies_categories' ?>" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group">
                      <label for="exampleInputName1">Nama Jenis Kategori</label>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input required class="form-control" type="file" id="icon" name="picture" required="" accept="image/*">
                    </div>
