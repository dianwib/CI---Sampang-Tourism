<div class="wrapper">
  <nav>
    ...
    <ul>
      ...
      <li><a href="<?php echo base_url().'admin/photos_gallery'?>" class="active">Photos-gallery</a></li>
...
<head>
  ...
  <title>Admin photos gallery</title>
...
<body>
    <div class="well">
        <a href="<?php echo base_url().'admin/tambah_photos_gallery'?>"> <button type="button" id="btn-tambah" class="btn btn-success pull-right">
            <span class="glyphicon glyphicon-plus"></span>  Tambah Data</button></a>
        
        <h2 style="margin-top: 0;">Data photos_gallery</h2>
    </div>
  ...
  <table class="table table-bordered">
    ...
    ?>
      <tr>
        ...
        <td class="align-middle"><img src="<?=base_url().'images/photos_gallery/'.$data['photo']; ?>" height="200"></td>
        <td class="align-middle"><?php echo $data['created_at']; ?></td>
        <!-- <td class="align-middle"><?php echo $data->updated_at; ?></td>
         -->
         <!-- <td class="align-middle text-center">
          <a href="<?php echo base_url().'admin/edit_photos_gallery/'.$data['id']?>" data-id="<?php echo $data['id']; ?>"  class="btn btn-default btn-form-ubah"><span class="glyphicon glyphicon-pencil"></span>ubah</a>

        </td> -->
        <td class="align-middle text-center">
          <a href="<?php echo base_url().'admin/delete_photos_gallery/'.$data['id']?>" onclick="return confirm('Are you sure delete?')" class="btn btn-danger btn-alert-hapus"><span class="glyphicon glyphicon-erase"></span>hapus</a>
        </td>
      </tr>
    <?php
