...
<body>
    ...
    <div class="table-responsive">
      <form class="form-signin" action="<?php echo base_url().'Admin/post_slides' ?>" method="post" enctype="multipart/form-data">
            <table>
  ...
  <table class="table table-bordered">
    <tr>
      ...
      <tr>
              ...
              </td><td><input required class="picture-value" type="file" name="picture" required="" accept="image/*">       
        </td>
      </tr>
