  ...
  <table class="table table-bordered">
    <tr>
      ...
      <tr>
                    ...
                    <td>
<select name="economies_id" required>
<?php
...
?>
              ...
              </td><td><img src="<?=base_url().'images/creative_economies/'.$data->photo; ?>" height="200">
   ...
   <table class="table table-bordered">
    <tr>
      ...
      <tr>
              ...
              <td><input type="text" class="title-value" name="contact_person" value="<?php echo $data->contact_person; ?>" required>
              </td>
