...
<head>
    ...
    <title><?php echo $data_destinations['title']?></title>
...
Javascript is set up so that you can add as many images as you like, but make sure that you match the number of 'circle' span elements (below) to the number of images -->
  ...
  <img class="imageSlides" src=<?php echo $base_url.'/upload/destinations/'.$data_destinations['photo']?>>
...
@keyframes anim-1 {
 ...
 <p style="text-transform: capitalize;text-align: center;margin-left: auto;margin-right: auto; font-family: 'Lobster',cursive;" class="item-1"><?php echo $data_destinations['title']?></p>
 </div>
        ...
        <div class="container">
            ...
            <div class="row about_row">
                <div class="who_we_area col-md-7 col-sm-6" style="overflow-wrap: break-word;background:#fffca3;padding: 4%;">
                    <div class="subtittle" >
                        <h2  style="text-transform: capitalize;" ><?php echo $data_destinations['title']?></h2>
                    </div>
                    <p><?php echo $data_destinations['description']?></p>
                     <a href="#" class="button_all"><i  class="fa fa-clock-o" aria-hidden="true"></i><?php echo ' '. $data_destinations['opening_hours']. ' - '. $data_destinations['closing_hours']?></a><br>
                    <a href="#" class="button_all"><i  class="fa fa-map-marker" aria-hidden="true"></i><?php echo ' '. $data_destinations['address']?></a>
                </div>
